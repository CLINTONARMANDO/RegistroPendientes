...
import com.clindevstu.registropendientes.ui.modules.registrorecojo.agregarregistrorecojo.AgregarRegistroRecojoScreen
import com.clindevstu.registropendientes.ui.modules.registrorecojo.registrorecojodetalle.RegistroRecojoDetalleScreen
...
fun RegistroRecojoScreen (navController: NavHostController, viewModel: RegistroRecojoViewModel){
    ...
    Scaffold(
        topBar = {
            CTopBarSecondary(
                title = "Registro Recojo",
                subtitle = "Registro de Recojo de Routers",
        ...
        Column(
            ...
            when (state) {
                is RegistroRecojoState.Init,
                is RegistroRecojoState.Loading -> {
                    // Puedes poner un shimmer o CircularProgressIndicator
                    CircularProgressIndicator(modifier = Modifier.padding(16.dp))
                }

                is RegistroRecojoState.Error -> {
                    val message = (state as RegistroRecojoState.Error).message
                    Text(
                        text = "Error: $message",
                ...
                is RegistroRecojoState.Success -> {
                    ...
                    if (listaRegistros.isEmpty()) {
                        ...
                        listaRegistros.forEach { registro ->
                            ...
                            CCardGridData(
                                principalIcon = painterResource(id = R.drawable.registro_recojo_icon),
                                title = registro.id ?: "Sin Cliente",
                                ...
                                headers = listOf("Asesor", "Empresa", "Ciudad", "Tipo", "FechaRecojo", "FechaRegistro"),
                                data = listOf(
                                    registro.asesor ?: "N/A",
                                    registro.empresa ?: "N/A",
                                    registro.ciudadZona ?: "N/A",
                                    registro.tipoRegistro ?: "N/A",
                                    AppFunctions.formatearFecha(registro.fechaRecojo),
    ...
    if (isDetalleDialogActive) {
        CFullScreenModal(
            ...
            RegistroRecojoDetalleScreen(viewModel) // Aquí el detalle real
        }
    }
}